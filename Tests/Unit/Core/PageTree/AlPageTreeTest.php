...
namespace AlphaLemon\PageTreeBundle\Tests\Unit\Core\PageTree;
...
class AlPageTreeTest extends TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->pageBlocks = $this->getMockBuilder('AlphaLemon\PageTreeBundle\Core\PageBlocks\AlPageBlocks')
                                    ->disableOriginalConstructor()
                                    ->getMock();
