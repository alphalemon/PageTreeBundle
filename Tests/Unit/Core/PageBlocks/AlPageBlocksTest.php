...
namespace AlphaLemon\PageTreeBundle\Tests\Unit\Core\PageBlocks;

use AlphaLemon\PageTreeBundle\Tests\TestCase;
use AlphaLemon\PageTreeBundle\Core\PageBlocks\AlPageBlocks;
...
class AlPageBlocksTest extends TestCase
{
    ...
    /**
     * @expectedException AlphaLemon\PageTreeBundle\Core\Exception\General\AnyValidParameterGivenException
     */
    ...
    /**
     * @expectedException AlphaLemon\PageTreeBundle\Core\Exception\General\InvalidParameterException
     */
